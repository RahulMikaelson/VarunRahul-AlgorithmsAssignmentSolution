...
public class SortingDes {
	// Arranging in Descending Order
	public void  DescendingOrder(double[] StockValue, int left, int right ){
		if (left<right) {
			int mid = (left +right)/2;
			DescendingOrder(StockValue , left, mid);
			DescendingOrder (StockValue ,mid+1 , right );
